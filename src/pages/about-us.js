...
const AboutUsPage = () => (
  ...
  <h1 css={{'@media (min-width: 100px)': {paddingLeft: "70px",
              paddingRight: "70px"}}}>Made by Brewers for Brewers</h1>
  <p css={{'@media (min-width: 100px)': {paddingLeft: "70px",
              ...
              With decades of experience in the brewing industry, we’ve purchased, installed and used a lot of brewing equipment for our own brewery. Combined with a passion for brewing excellent beer, a few years later, BrewPlus was born.  <br /> <br />
